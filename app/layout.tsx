...
export const metadata: Metadata = {
  title: {
    default: "لمعة للاكسسوارات المطلية | متجر اكسسوارات فاخر",
    template: "%s | لمعة للاكسسوارات المطلية",
  },
  description: "متجر مجوهرات وإكسسوارات نسائية فاخرة — تشكيلة مختارة بعناية من الذهب المطلي والقطع الراقية",
  icons: {
    icon: "/icon.svg",
    shortcut: "/icon.svg",
    apple: "/icon.svg",
