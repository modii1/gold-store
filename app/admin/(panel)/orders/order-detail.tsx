...
const statusConfig: Record<string, { label: string; cls: string; icon: typeof CheckCircle2 }> = {
  ...
  shipped: { label: "جاري الشحن", cls: "bg-blue-50 text-blue-700 border border-blue-200", icon: Truck },
  picked_up: { label: "تم استلام الشحنة", cls: "bg-violet-50 text-violet-700 border border-violet-200", icon: Truck },
  in_transit: { label: "في الطريق", cls: "bg-blue-50 text-blue-700 border border-blue-200", icon: Truck },
  out_for_delivery: { label: "خرج للتوصيل", cls: "bg-cyan-50 text-cyan-700 border border-cyan-200", icon: Truck },
