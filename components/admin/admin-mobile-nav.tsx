...
import { LayoutDashboard, Package, ShoppingCart, Settings, Tag, FolderOpen, Users, Truck, Zap, PackageSearch, RotateCcw, Bell, Settings2, FileText, LayoutTemplate } from "lucide-react";
...
const links = [
  ...
  { href: "/admin/sections", label: "أقسام الرئيسية", icon: LayoutTemplate },
