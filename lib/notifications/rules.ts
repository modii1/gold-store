...
export const BUILT_IN_RULES: Omit<Rule, "is_active">[] = [
  ...
  { event_type: "shipment.tracking_available", name: "رقم التتبع متاح", condition: {}, channels: ["in_app", "email", "sms"], recipients: ["admin"] },
  ...
  { event_type: "shipment.on_hold", name: "شحنة معلقة", condition: {}, channels: ["in_app", "email", "sms"], recipients: ["admin", "shipping_manager"] },
